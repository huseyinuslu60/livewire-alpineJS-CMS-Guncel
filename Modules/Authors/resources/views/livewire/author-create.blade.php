        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                <div class="flex items-center mb-4 lg:mb-0">
                    ...
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Yeni Yazar Ekle</h1>
                        <p class="text-gray-600">Sisteme yeni bir yazar profili ekleyin</p>
                    </div>
                </div>
                <div>
        ...
        <div class="p-6">
            <form wire:submit.prevent="save">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    <div>
                        <label for="user_id" class="block text-sm font-semibold text-gray-700 mb-2">Kullanıcı <span class="text-red-500">*</span></label>
                        <select wire:model.defer="user_id" class="block w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm" id="user_id">
                ...
                <div class="mb-6">
                    ...
                    @if($image)
                        <div class="mt-4">
                            <div class="flex items-center">
                                <img src="{{ $image->temporaryUrl() }}" alt="Önizleme" class="w-16 h-16 rounded-full object-cover mr-3">
                                <div>
                                    <h6 class="text-sm font-medium text-gray-900">Önizleme</h6>
                                    <p class="text-xs text-gray-500">Yeni profil fotoğrafı</p>
                                </div>
                            </div>
                        </div>
                    @endif
                ...
                <div class="flex justify-end space-x-4">
                    ...
                    <button type="submit" class="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-6 py-3 rounded-lg font-medium hover:from-blue-600 hover:to-purple-700 transition-all duration-300 shadow-sm hover:shadow-md">
