    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center">
                ...
                <div>
                    <h2 class="text-xl font-bold text-gray-900">Hisse Senedi Düzenle</h2>
                    <p class="text-gray-600">{{ $stock->name }} - {{ $stock->unvan }}</p>
                </div>
            </div>
        </div>

        <form wire:submit.prevent="update" class="p-6 banks-form">
