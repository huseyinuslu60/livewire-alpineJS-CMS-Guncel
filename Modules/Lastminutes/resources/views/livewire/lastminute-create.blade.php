        ...
        <div class="p-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center mb-4 sm:mb-0">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900 mb-1">Yeni Son Dakika</h2>
                        <p class="text-gray-600">Son dakika haberi oluşturun</p>
                    </div>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                <div class="p-6">
                    <form wire:submit.prevent="saveLastminute">
                        <!-- Başlık -->
                        <div class="mb-6">
                        ...
                        <div class="mb-6">
                            <label for="redirect" class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fas fa-external-link-alt mr-1 text-red-500"></i>
                                Yönlendirme URL
                            </label>
                            <input type="url" 
                                   wire:model.live="redirect" 
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 sm:text-sm @error('redirect') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror" 
                                   id="redirect" 
                        ...
                        <div class="mb-6">
                            ...
                            <input type="datetime-local" 
                                   ...
                                   class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 sm:text-sm @error('end_at') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror" 
                                   id="end_at"
                        ...
                        <div class="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
                            ...
                            <button type="submit" 
                                    class="inline-flex items-center px-6 py-2 border border-transparent rounded-lg text-sm font-medium text-white bg-red-600 hover:bg-red-700 shadow-lg hover:shadow-xl transition-all duration-200 cursor-pointer">
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="weight" class="block text-sm font-medium text-gray-700 mb-2">
                                <i class="fas fa-weight-hanging mr-1 text-red-500"></i>
                                Ağırlık *
                            </label>
                            <input type="number" 
