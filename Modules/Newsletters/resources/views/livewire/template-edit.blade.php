            ...
            <div class="p-6">
                <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex items-center mb-4 lg:mb-0">
                        ...
                        <div>
                            <h2 class="text-2xl font-bold text-gray-900 mb-1">Template Düzenle</h2>
                            <p class="text-gray-600">{{ $template->name ?? 'Template' }} template'ini düzenleyin</p>
                        </div>
                    </div>
                ...
                <form wire:submit.prevent="save" class="space-y-6">
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <div wire:ignore>
                                    <textarea wire:model="header_html" rows="6"
                            ...
                            <div>
                                ...
                                <div wire:ignore>
                                    <textarea wire:model="content_html" rows="6"
                                              class="trumbowyg w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            ...
                            <div>
                                ...
                                <div wire:ignore>
                                    <textarea wire:model="footer_html" rows="6"
                                              class="trumbowyg w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                    ...
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-medium text-gray-900">Renk Ayarları</h3>
                            <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 text-sm text-blue-800">
                                <i class="fas fa-info-circle mr-2"></i>
                                <span>HTML template'lerinde <code class="bg-blue-100 px-1 rounded">@{{ primary_color }}</code>, <code class="bg-blue-100 px-1 rounded">@{{ secondary_color }}</code> gibi placeholder'lar kullanın.</span>
                            </div>
                        </div>
