                                                    ...
                                                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
                                                        ...
                                                        <div class="lg:col-span-2">
                                                            <div>
                                                                ...
                                                                <div wire:ignore>
                                                                    <trix-editor 
                                                                         id="description-editor-{{ $fileId }}" 
                                                                         class="trix-editor block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 sm:text-sm" 
                                                                         placeholder="Bu resim için detaylı açıklama yazın..."
                                                                         data-description="{{ $description }}"></trix-editor>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
