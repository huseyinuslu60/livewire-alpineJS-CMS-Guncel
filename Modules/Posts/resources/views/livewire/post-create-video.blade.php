        ...
        <div class="p-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div class="flex items-center mb-4 sm:mb-0">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-900 mb-1">Yeni Video Oluştur</h2>
                        <p class="text-gray-600">Video embed kodu ile içerik oluşturun</p>
                    </div>
                </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div wire:ignore>
                                <textarea wire:model.live="content" 
                                          class="trumbowyg block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-red-500 sm:text-sm @error('content') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror" 
                                          id="content" 
                                          rows="10" 
                                          placeholder="Video açıklamasını girin..."></textarea>
                            </div>
                            @error('content')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="mb-6">
                            ...
                            <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-red-400 transition-colors duration-200 relative">
                                ...
                                <label for="files" class="cursor-pointer">
                                    ...
                                    <p class="text-lg font-medium text-gray-700 mb-2">Thumbnail Seç veya Sürükle</p>
                            ...
                            @if($files)
                                <div class="mt-4">
                                    <h6 class="text-sm font-medium text-gray-700 mb-3">
                                        ...
                                        Seçilen Thumbnail'ler ({{ count($files) }})
                                    </h6>
                            ...
                            <p class="mt-2 text-xs text-gray-500">
                                <i class="fas fa-info-circle mr-1"></i>
                                Video için özel thumbnail görseli. JPG, PNG, GIF formatları desteklenir. Maksimum 4MB.
                            </p>
                        </div>
