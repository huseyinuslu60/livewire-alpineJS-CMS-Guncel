 ...
 * File Model Observer
 *
 * File oluşturulurken ve güncellenirken title, alt_text ve caption alanlarını sanitize eder.
...
class FileObserver
{
     ...
     */
    public function creating(\Modules\Files\Models\File $file): void
    {
     ...
     */
    public function updating(\Modules\Files\Models\File $file): void
    {
